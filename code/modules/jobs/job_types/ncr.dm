...
/datum/outfit/job/ncr/post_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	...
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/ncrsalvaged_ncr)
	...
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/ncrriot_ncr)
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/ncrriothelmet_ncr)
