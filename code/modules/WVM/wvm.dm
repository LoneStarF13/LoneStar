...
/obj/machinery/mineral/wasteland_vendor/followerterminal
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Prosthethic Left Arm",			/obj/item/bodypart/l_arm/robot,										600),
		new /datum/data/wasteland_equipment("Prosthethic Right Arm",		/obj/item/bodypart/r_arm/robot,										600),
		new /datum/data/wasteland_equipment("Prosthethic Left Leg",			/obj/item/bodypart/l_leg/robot,										600),
