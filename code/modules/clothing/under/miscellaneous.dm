...
/obj/item/clothing/under/scarecrow
	...
	desc = "Perfect camouflage for hiding in fields."
...
/obj/item/clothing/under/plasmaman
	name = "exotic envirosuit"
	desc = "A special containment suit that allows exotic lifeforms to exist safely in an oxygenated environment, and automatically extinguishes them in a crisis. Despite being airtight, it's not spaceworthy."
