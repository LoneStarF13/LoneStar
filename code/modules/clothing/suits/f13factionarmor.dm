...
/obj/item/clothing/suit/armor/f13/army/general
	name = "US Army general's overcoat"
	desc = "A large olive green overcoat, worn by pre-war United States Army generals. It has discrete armor plating in the lining, to foil assassination attempts."
	icon = 'icons/fallout/clothing/suits_cosmetic.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/suit_cosmetic.dmi'
	icon_state = "coat_general"
	item_state = "coat_general"
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 25, "bomb" = 25, "bio" = 15, "rad" = 10, "fire" = 15, "acid" = 5)
